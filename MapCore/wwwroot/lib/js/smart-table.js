  ...
  .controller('stTableController', ['$scope', '$parse', '$filter', '$attrs', function StTableController ($scope, $parse, $filter, $attrs) {
    ...
    this.pipe = function pipe () {
      ...
      if (tableState.sort.predicate) {
          var nullsToBottom = function (obj) {
              return ((angular.isDefined(obj) && obj !== null && angular.isDefined(obj[tableState.sort.predicate]) && obj[tableState.sort.predicate] === null) ? -1 : 0);
          };
          filtered = orderBy(filtered, [nullsToBottom].concat(tableState.sort.predicate), tableState.sort.reverse);
      }
